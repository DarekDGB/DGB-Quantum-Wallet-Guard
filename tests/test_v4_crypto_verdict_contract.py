...
from qwg.v4 import COMPONENT_ID, COMPONENT_ROLE, CONTRACT_VERSION, VERDICT_SCHEMA_VERSION
from qwg.v4.crypto_verdict import (
...
from qwg.v4.trust_profile import CLASSICAL_ED25519, FN_DSA, ML_DSA, build_test_trust_profile
...
def unsigned_payload() -> dict:
    return build_unsigned_crypto_verdict_payload(
        ...
        metadata={"pilot": "qwg-v4", "nested": {"safe": True}},
...
def test_qwg_v4_signed_component_verdict_contract_validates() -> None:
    payload = unsigned_payload()
