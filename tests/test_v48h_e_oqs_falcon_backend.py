...
import qwg.v4.oqs_falcon_backend as oqs_falcon_module
from qwg.v4.oqs_falcon_backend import OQS_FALCON_MECHANISM, OqsFalcon1024Backend
from qwg.v4.signing import COMPONENT_VERDICT_DOMAIN as DOMAIN_TAG
from qwg.v4.trust_profile import FIPS206_DRAFT_FALCON1024_PROFILE
from qwg.v4 import COMPONENT_ROLE
from qwg.v4.real_crypto_backend import (
    QwgV4RealCryptoBackendError as BackendError,
    QwgV4RealCryptoBackendUnavailable as BackendUnavailable,
...
PAYLOAD_HASH = "e" * 64
PUBLIC_KEY_BYTES = b'shield-v48h-e-qwg-falcon-public-key'
PRIVATE_KEY_BYTES = PUBLIC_KEY_BYTES
PRIVATE_KEY_REFERENCE = "hsm://qwg/fn-dsa-falcon1024/v1"
