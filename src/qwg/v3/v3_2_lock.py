...
COMPONENT_ID = 'qwg'
COMPONENT_NAME = 'DGB Quantum Wallet Guard'
SUPPORTED_REASON_IDS = ('QWG_OK_POSTURE_ALLOW', 'QWG_ESCALATE_QUANTUM_POSTURE', 'QWG_DENY_KEY_RISK', 'QWG_ERROR_INVALID_VERDICT', 'QWG_ERROR_CONTEXT_HASH_MISMATCH')
SUPPORTED_EVIDENCE_FAMILIES = ('wallet_posture', 'quantum_risk_context', 'key_age_context', 'dormancy_context')
