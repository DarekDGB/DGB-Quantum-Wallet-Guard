...
This document defines the first QWG Shield v4 component-verdict contract.
...
The V4.4 QWG pilot uses deterministic TEST-ONLY signatures for contract and CI locking.
